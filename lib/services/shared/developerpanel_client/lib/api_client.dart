...
class ApiClient {
  ApiClient({
    this.basePath = 'https://app.corbado.com/api',
    this.authentication,
  });
    ...
    try {
      switch (targetType) {
        ...
        case 'V1ProjectsDeleteDelete200Response':
          return V1ProjectsDeleteDelete200Response.fromJson(value);
        case 'V1ProjectsDeleteDeleteRequest':
          return V1ProjectsDeleteDeleteRequest.fromJson(value);
        case 'V1ProjectsGet200Response':
