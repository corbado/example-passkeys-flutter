...
/// tests for EmailMagicLinksApi
void main() {
  // final instance = EmailMagicLinksApi();

  group('tests for EmailMagicLinksApi', () {
    ...
    test('test emailLinkDelete', () async {
      // TODO
    });
    ...
    test('test emailLinkValidate', () async {
      // TODO
    });
