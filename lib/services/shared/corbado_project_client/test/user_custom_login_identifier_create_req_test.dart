...
// tests for UserCustomLoginIdentifierCreateReq
void main() {
  // final instance = UserCustomLoginIdentifierCreateReq();

  group('test UserCustomLoginIdentifierCreateReq', () {
    // String customLoginIdentifier
    test('to test the property `customLoginIdentifier`', () async {
      // TODO
    });

    // String additionalData
    test('to test the property `additionalData`', () async {
      // TODO
    });
