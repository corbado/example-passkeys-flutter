...
/// tests for IOSAppConfigApi
void main() {
  // final instance = IOSAppConfigApi();

  group('tests for IOSAppConfigApi', () {
    // Creates a new iOS App Config
    //
    //Future<IOSAppConfigSaveRsp> iOSAppConfigCreate(IOSAppConfigSaveReq iOSAppConfigSaveReq) async
    test('test iOSAppConfigCreate', () async {
      // TODO
    });
    ...
    test('test iOSAppConfigDelete', () async {
      // TODO
    });
    ...
    test('test iOSAppConfigGet', () async {
      // TODO
    });
    ...
    test('test iOSAppConfigPut', () async {
      // TODO
    });
  });
}
