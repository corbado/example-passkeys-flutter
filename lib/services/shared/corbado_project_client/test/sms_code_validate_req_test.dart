...
// tests for SmsCodeValidateReq
void main() {
  // final instance = SmsCodeValidateReq();

  group('test SmsCodeValidateReq', () {
    // SMS OTP to validate
    // String smsCode
    test('to test the property `smsCode`', () async {
      // TODO
    });

    // bool createLoginToken
    test('to test the property `createLoginToken`', () async {
      // TODO
    });
