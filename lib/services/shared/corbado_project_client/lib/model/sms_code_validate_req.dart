...
class SmsCodeValidateReq {
  /// Returns a new [SmsCodeValidateReq] instance.
  SmsCodeValidateReq({
  ...
  /// Returns a new [SmsCodeValidateReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SmsCodeValidateReq? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<SmsCodeValidateReq> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SmsCodeValidateReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SmsCodeValidateReq> mapFromJson(dynamic json) {
    final map = <String, SmsCodeValidateReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SmsCodeValidateReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
