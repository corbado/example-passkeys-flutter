...
class LongSessionGetRspAllOfData {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LongSessionGetRspAllOfData &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LongSessionGetRspAllOfData[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LongSessionGetRspAllOfData[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<LongSessionGetRspAllOfData> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<LongSessionGetRspAllOfData>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LongSessionGetRspAllOfData>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LongSessionGetRspAllOfData.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
