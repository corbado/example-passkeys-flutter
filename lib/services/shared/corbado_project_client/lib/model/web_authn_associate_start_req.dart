...
class WebAuthnAssociateStartReq {
  /// Returns a new [WebAuthnAssociateStartReq] instance.
  ...
  /// Returns a new [WebAuthnAssociateStartReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static WebAuthnAssociateStartReq? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return WebAuthnAssociateStartReq(
  ...
  static List<WebAuthnAssociateStartReq> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = WebAuthnAssociateStartReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, WebAuthnAssociateStartReq> mapFromJson(dynamic json) {
    final map = <String, WebAuthnAssociateStartReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WebAuthnAssociateStartReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
