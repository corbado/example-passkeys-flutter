...
class TrackingOSDetailedStatsListRspAllOf {
  ...
  bool operator ==(Object other) =>
      ...
      other is TrackingOSDetailedStatsListRspAllOf && other.data == data;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "TrackingOSDetailedStatsListRspAllOf[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "TrackingOSDetailedStatsListRspAllOf[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TrackingOSDetailedStatsListRspAllOf> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, TrackingOSDetailedStatsListRspAllOf> mapFromJson(
      dynamic json) {
  ...
  static Map<String, List<TrackingOSDetailedStatsListRspAllOf>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = TrackingOSDetailedStatsListRspAllOf.listFromJson(
          entry.value,
          growable: growable,
        );
      }
