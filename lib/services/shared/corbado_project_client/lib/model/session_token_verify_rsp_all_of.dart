...
class SessionTokenVerifyRspAllOf {
  ...
  bool operator ==(Object other) =>
      ...
      other is SessionTokenVerifyRspAllOf && other.data == data;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "SessionTokenVerifyRspAllOf[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "SessionTokenVerifyRspAllOf[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SessionTokenVerifyRspAllOf> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SessionTokenVerifyRspAllOf>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SessionTokenVerifyRspAllOf.listFromJson(
          entry.value,
          growable: growable,
        );
      }
