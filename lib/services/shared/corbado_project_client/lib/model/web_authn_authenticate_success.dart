...
class WebAuthnAuthenticateSuccess {
  ...
  bool operator ==(Object other) =>
      ...
      other is WebAuthnAuthenticateSuccess &&
  ...
  @override
  String toString() =>
      'WebAuthnAuthenticateSuccess[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, userID=$userID, username=$username, credentialID=$credentialID, userFullName=$userFullName]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "WebAuthnAuthenticateSuccess[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "WebAuthnAuthenticateSuccess[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<WebAuthnAuthenticateSuccess> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<WebAuthnAuthenticateSuccess>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = WebAuthnAuthenticateSuccess.listFromJson(
          entry.value,
          growable: growable,
        );
      }
