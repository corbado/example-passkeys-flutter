...
class SmsTemplateCreateRspAllOfData {
  /// Returns a new [SmsTemplateCreateRspAllOfData] instance.
  ...
  /// Returns a new [SmsTemplateCreateRspAllOfData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SmsTemplateCreateRspAllOfData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SmsTemplateCreateRspAllOfData(
        smsTemplateID: mapValueOfType<String>(json, r'smsTemplateID')!,
      );
    }
    return null;
  }
  ...
  static List<SmsTemplateCreateRspAllOfData> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SmsTemplateCreateRspAllOfData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SmsTemplateCreateRspAllOfData> mapFromJson(dynamic json) {
    final map = <String, SmsTemplateCreateRspAllOfData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SmsTemplateCreateRspAllOfData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
