...
class WebauthnSettingGetRsp {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is WebauthnSettingGetRsp &&
  ...
  @override
  String toString() => 'WebauthnSettingGetRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, name=$name, origin=$origin, id=$id, created=$created, updated=$updated]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "WebauthnSettingGetRsp[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "WebauthnSettingGetRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<WebauthnSettingGetRsp> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<WebauthnSettingGetRsp>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<WebauthnSettingGetRsp>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = WebauthnSettingGetRsp.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
