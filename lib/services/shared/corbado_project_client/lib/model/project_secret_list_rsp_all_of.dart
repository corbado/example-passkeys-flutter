...
class ProjectSecretListRspAllOf {
  ...
  bool operator ==(Object other) =>
      ...
      other is ProjectSecretListRspAllOf &&
          other.rows == rows &&
          other.paging == paging;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ProjectSecretListRspAllOf[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ProjectSecretListRspAllOf[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ProjectSecretListRspAllOf> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ProjectSecretListRspAllOf>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ProjectSecretListRspAllOf.listFromJson(
          entry.value,
          growable: growable,
        );
      }
