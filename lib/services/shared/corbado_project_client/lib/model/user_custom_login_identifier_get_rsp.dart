...
class UserCustomLoginIdentifierGetRsp {
  ...
  bool operator ==(Object other) =>
      ...
      other is UserCustomLoginIdentifierGetRsp &&
  ...
  @override
  String toString() =>
      'UserCustomLoginIdentifierGetRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "UserCustomLoginIdentifierGetRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "UserCustomLoginIdentifierGetRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UserCustomLoginIdentifierGetRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, UserCustomLoginIdentifierGetRsp> mapFromJson(
      dynamic json) {
  ...
  static Map<String, List<UserCustomLoginIdentifierGetRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = UserCustomLoginIdentifierGetRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
