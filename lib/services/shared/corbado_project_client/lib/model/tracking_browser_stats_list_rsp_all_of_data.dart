...
class TrackingBrowserStatsListRspAllOfData {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TrackingBrowserStatsListRspAllOfData &&
     other.stats == stats &&
     other.paging == paging;
  ...
  @override
  String toString() => 'TrackingBrowserStatsListRspAllOfData[stats=$stats, paging=$paging]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TrackingBrowserStatsListRspAllOfData[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TrackingBrowserStatsListRspAllOfData[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TrackingBrowserStatsListRspAllOfData> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, TrackingBrowserStatsListRspAllOfData> mapFromJson(dynamic json) {
    final map = <String, TrackingBrowserStatsListRspAllOfData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TrackingBrowserStatsListRspAllOfData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<TrackingBrowserStatsListRspAllOfData>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TrackingBrowserStatsListRspAllOfData>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TrackingBrowserStatsListRspAllOfData.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
