...
class SmsCodeValidateRsp {
  /// Returns a new [SmsCodeValidateRsp] instance.
  SmsCodeValidateRsp({
  ...
  /// Returns a new [SmsCodeValidateRsp] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SmsCodeValidateRsp? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<SmsCodeValidateRsp> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SmsCodeValidateRsp.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SmsCodeValidateRsp> mapFromJson(dynamic json) {
    final map = <String, SmsCodeValidateRsp>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SmsCodeValidateRsp.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
