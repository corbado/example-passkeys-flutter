...
class ProjectConfigWebhookTestRspAllOfData {
  /// Returns a new [ProjectConfigWebhookTestRspAllOfData] instance.
  ...
  /// Returns a new [ProjectConfigWebhookTestRspAllOfData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ProjectConfigWebhookTestRspAllOfData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ProjectConfigWebhookTestRspAllOfData(
  ...
  static List<ProjectConfigWebhookTestRspAllOfData> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProjectConfigWebhookTestRspAllOfData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
