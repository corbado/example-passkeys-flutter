...
class TrackingBackupState {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TrackingBackupState &&
  ...
  int get hashCode =>
    ...
    (backedUp.hashCode) +
    (notBackedUp.hashCode);

  @override
  String toString() => 'TrackingBackupState[backedUp=$backedUp, notBackedUp=$notBackedUp]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TrackingBackupState[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TrackingBackupState[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TrackingBackupState> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<TrackingBackupState>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TrackingBackupState>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TrackingBackupState.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
