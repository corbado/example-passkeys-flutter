...
class ValidatePhoneNumberReq {
  /// Returns a new [ValidatePhoneNumberReq] instance.
  ...
  /// Returns a new [ValidatePhoneNumberReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ValidatePhoneNumberReq? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ValidatePhoneNumberReq> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ValidatePhoneNumberReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ValidatePhoneNumberReq> mapFromJson(dynamic json) {
    final map = <String, ValidatePhoneNumberReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ValidatePhoneNumberReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
