...
class UserPhoneNumberCreateReq {
  /// Returns a new [UserPhoneNumberCreateReq] instance.
  ...
  /// Returns a new [UserPhoneNumberCreateReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UserPhoneNumberCreateReq? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UserPhoneNumberCreateReq(
  ...
  static List<UserPhoneNumberCreateReq> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UserPhoneNumberCreateReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UserPhoneNumberCreateReq> mapFromJson(dynamic json) {
    final map = <String, UserPhoneNumberCreateReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UserPhoneNumberCreateReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
