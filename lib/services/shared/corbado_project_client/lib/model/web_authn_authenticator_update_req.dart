...
class WebAuthnAuthenticatorUpdateReq {
  /// Returns a new [WebAuthnAuthenticatorUpdateReq] instance.
  ...
  /// Returns a new [WebAuthnAuthenticatorUpdateReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static WebAuthnAuthenticatorUpdateReq? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return WebAuthnAuthenticatorUpdateReq(
  ...
  static List<WebAuthnAuthenticatorUpdateReq> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = WebAuthnAuthenticatorUpdateReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, WebAuthnAuthenticatorUpdateReq> mapFromJson(dynamic json) {
    final map = <String, WebAuthnAuthenticatorUpdateReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WebAuthnAuthenticatorUpdateReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
