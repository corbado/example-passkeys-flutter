...
class UserEmailDeleteReq {
  ...
  @override
  String toString() =>
      'UserEmailDeleteReq[requestID=$requestID, clientInfo=$clientInfo]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "UserEmailDeleteReq[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "UserEmailDeleteReq[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UserEmailDeleteReq> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<UserEmailDeleteReq>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = UserEmailDeleteReq.listFromJson(
          entry.value,
          growable: growable,
        );
      }
