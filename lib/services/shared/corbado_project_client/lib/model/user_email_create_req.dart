...
class UserEmailCreateReq {
  /// Returns a new [UserEmailCreateReq] instance.
  UserEmailCreateReq({
    required this.email,
    this.requestID,
    this.clientInfo,
  ...
  /// Returns a new [UserEmailCreateReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UserEmailCreateReq? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<UserEmailCreateReq> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UserEmailCreateReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UserEmailCreateReq> mapFromJson(dynamic json) {
    final map = <String, UserEmailCreateReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UserEmailCreateReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
