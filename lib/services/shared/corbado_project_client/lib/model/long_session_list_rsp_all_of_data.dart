...
class LongSessionListRspAllOfData {
  /// Returns a new [LongSessionListRspAllOfData] instance.
  LongSessionListRspAllOfData({
    this.longSessions = const [],
    required this.paging,
  });

  List<LongSession> longSessions;
  ...
  /// Returns a new [LongSessionListRspAllOfData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LongSessionListRspAllOfData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return LongSessionListRspAllOfData(
        longSessions: LongSession.listFromJson(json[r'longSessions']),
  ...
  static List<LongSessionListRspAllOfData> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LongSessionListRspAllOfData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LongSessionListRspAllOfData> mapFromJson(dynamic json) {
    final map = <String, LongSessionListRspAllOfData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LongSessionListRspAllOfData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
