...
class SessionConfig {
  ...
  static SessionConfig? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "SessionConfig[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "SessionConfig[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SessionConfig(
        ...
        shortCookieSameSite: SessionConfigShortCookieSameSiteEnum.fromJson(
            json[r'shortCookieSameSite'])!,
        longLifetimeValue: mapValueOfType<int>(json, r'longLifetimeValue')!,
        longLifetimeUnit: SessionConfigLongLifetimeUnitEnum.fromJson(
            json[r'longLifetimeUnit'])!,
        longInactivityValue: mapValueOfType<int>(json, r'longInactivityValue')!,
        longInactivityUnit: SessionConfigLongInactivityUnitEnum.fromJson(
  ...
  static List<SessionConfig> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SessionConfig>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SessionConfig.listFromJson(
          entry.value,
          growable: growable,
        );
      }
...
class SessionConfigShortCookieSameSiteEnum {
  ...
  static SessionConfigShortCookieSameSiteEnum? fromJson(dynamic value) =>
      SessionConfigShortCookieSameSiteEnumTypeTransformer().decode(value);

  static List<SessionConfigShortCookieSameSiteEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class SessionConfigShortCookieSameSiteEnumTypeTransformer {
  factory SessionConfigShortCookieSameSiteEnumTypeTransformer() => _instance ??=
  ...
  SessionConfigShortCookieSameSiteEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'lax':
          return SessionConfigShortCookieSameSiteEnum.lax;
        case r'strict':
          return SessionConfigShortCookieSameSiteEnum.strict;
        case r'none':
          return SessionConfigShortCookieSameSiteEnum.none;
        default:
          if (!allowNull) {
...
class SessionConfigLongLifetimeUnitEnum {
  ...
  static SessionConfigLongLifetimeUnitEnum? fromJson(dynamic value) =>
      SessionConfigLongLifetimeUnitEnumTypeTransformer().decode(value);

  static List<SessionConfigLongLifetimeUnitEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class SessionConfigLongLifetimeUnitEnumTypeTransformer {
  factory SessionConfigLongLifetimeUnitEnumTypeTransformer() =>
      _instance ??= const SessionConfigLongLifetimeUnitEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SessionConfigLongLifetimeUnitEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'min':
          return SessionConfigLongLifetimeUnitEnum.min;
        case r'hour':
          return SessionConfigLongLifetimeUnitEnum.hour;
        case r'day':
          return SessionConfigLongLifetimeUnitEnum.day;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
...
class SessionConfigLongInactivityUnitEnum {
  ...
  static SessionConfigLongInactivityUnitEnum? fromJson(dynamic value) =>
      SessionConfigLongInactivityUnitEnumTypeTransformer().decode(value);

  static List<SessionConfigLongInactivityUnitEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class SessionConfigLongInactivityUnitEnumTypeTransformer {
  factory SessionConfigLongInactivityUnitEnumTypeTransformer() => _instance ??=
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SessionConfigLongInactivityUnitEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'min':
          return SessionConfigLongInactivityUnitEnum.min;
        case r'hour':
          return SessionConfigLongInactivityUnitEnum.hour;
        case r'day':
          return SessionConfigLongInactivityUnitEnum.day;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
