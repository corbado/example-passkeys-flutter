...
class EmailTemplateDeleteReq {
  /// Returns a new [EmailTemplateDeleteReq] instance.
  ...
  /// Returns a new [EmailTemplateDeleteReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EmailTemplateDeleteReq? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<EmailTemplateDeleteReq> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EmailTemplateDeleteReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EmailTemplateDeleteReq> mapFromJson(dynamic json) {
    final map = <String, EmailTemplateDeleteReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EmailTemplateDeleteReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
