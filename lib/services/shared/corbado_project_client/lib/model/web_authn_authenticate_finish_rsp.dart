...
class WebAuthnAuthenticateFinishRsp {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is WebAuthnAuthenticateFinishRsp &&
  ...
  @override
  String toString() => 'WebAuthnAuthenticateFinishRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, userID=$userID, username=$username, credentialID=$credentialID, status=$status, userFullName=$userFullName]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "WebAuthnAuthenticateFinishRsp[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "WebAuthnAuthenticateFinishRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return WebAuthnAuthenticateFinishRsp(
        ...
        status: WebAuthnAuthenticateFinishRspStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<WebAuthnAuthenticateFinishRsp> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<WebAuthnAuthenticateFinishRsp>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<WebAuthnAuthenticateFinishRsp>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = WebAuthnAuthenticateFinishRsp.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class WebAuthnAuthenticateFinishRspStatusEnum {
  ...
  static const unconfirmedCredential = WebAuthnAuthenticateFinishRspStatusEnum._(r'unconfirmedCredential');
  ...
  static WebAuthnAuthenticateFinishRspStatusEnum? fromJson(dynamic value) => WebAuthnAuthenticateFinishRspStatusEnumTypeTransformer().decode(value);

  static List<WebAuthnAuthenticateFinishRspStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class WebAuthnAuthenticateFinishRspStatusEnumTypeTransformer {
  factory WebAuthnAuthenticateFinishRspStatusEnumTypeTransformer() => _instance ??= const WebAuthnAuthenticateFinishRspStatusEnumTypeTransformer._();
  ...
  WebAuthnAuthenticateFinishRspStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'success': return WebAuthnAuthenticateFinishRspStatusEnum.success;
        case r'unconfirmedCredential': return WebAuthnAuthenticateFinishRspStatusEnum.unconfirmedCredential;
        default:
          if (!allowNull) {
