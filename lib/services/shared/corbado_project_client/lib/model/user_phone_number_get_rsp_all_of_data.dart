...
class UserPhoneNumberGetRspAllOfData {
  /// Returns a new [UserPhoneNumberGetRspAllOfData] instance.
  ...
  /// Returns a new [UserPhoneNumberGetRspAllOfData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UserPhoneNumberGetRspAllOfData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UserPhoneNumberGetRspAllOfData(
        phoneNumber: PhoneNumber.fromJson(json[r'phoneNumber'])!,
      );
    }
    return null;
  }
  ...
  static List<UserPhoneNumberGetRspAllOfData> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UserPhoneNumberGetRspAllOfData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UserPhoneNumberGetRspAllOfData> mapFromJson(dynamic json) {
    final map = <String, UserPhoneNumberGetRspAllOfData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UserPhoneNumberGetRspAllOfData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
