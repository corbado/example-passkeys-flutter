...
class IOSAppConfigListRsp {
  ...
  @override
  String toString() =>
      'IOSAppConfigListRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, rows=$rows, paging=$paging]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IOSAppConfigListRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IOSAppConfigListRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IOSAppConfigListRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<IOSAppConfigListRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IOSAppConfigListRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
