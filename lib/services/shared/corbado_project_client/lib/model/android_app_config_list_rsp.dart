...
class AndroidAppConfigListRsp {
  ...
  bool operator ==(Object other) =>
      ...
      other is AndroidAppConfigListRsp &&
  ...
  @override
  String toString() =>
      'AndroidAppConfigListRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, rows=$rows, paging=$paging]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "AndroidAppConfigListRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "AndroidAppConfigListRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AndroidAppConfigListRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<AndroidAppConfigListRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = AndroidAppConfigListRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
