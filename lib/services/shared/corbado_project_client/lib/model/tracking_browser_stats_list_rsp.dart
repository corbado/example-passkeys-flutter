...
class TrackingBrowserStatsListRsp {
  ...
  bool operator ==(Object other) =>
      ...
      other is TrackingBrowserStatsListRsp &&
  ...
  @override
  String toString() =>
      'TrackingBrowserStatsListRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "TrackingBrowserStatsListRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "TrackingBrowserStatsListRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TrackingBrowserStatsListRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<TrackingBrowserStatsListRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = TrackingBrowserStatsListRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
