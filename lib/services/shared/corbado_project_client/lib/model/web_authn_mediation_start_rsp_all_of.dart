...
class WebAuthnMediationStartRspAllOf {
  ...
  bool operator ==(Object other) =>
      ...
      other is WebAuthnMediationStartRspAllOf && other.challenge == challenge;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "WebAuthnMediationStartRspAllOf[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "WebAuthnMediationStartRspAllOf[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<WebAuthnMediationStartRspAllOf> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<WebAuthnMediationStartRspAllOf>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = WebAuthnMediationStartRspAllOf.listFromJson(
          entry.value,
          growable: growable,
        );
      }
