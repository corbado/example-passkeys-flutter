...
class UserEmailCreateRsp {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UserEmailCreateRsp &&
  ...
  @override
  String toString() => 'UserEmailCreateRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UserEmailCreateRsp[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UserEmailCreateRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UserEmailCreateRsp> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<UserEmailCreateRsp>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UserEmailCreateRsp>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UserEmailCreateRsp.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
