...
class TrackingDetailedStatsListRspAllOfData {
  /// Returns a new [TrackingDetailedStatsListRspAllOfData] instance.
  TrackingDetailedStatsListRspAllOfData({
    this.stats = const [],
    required this.paging,
  });

  List<TrackingDetailedStats> stats;
  ...
  /// Returns a new [TrackingDetailedStatsListRspAllOfData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TrackingDetailedStatsListRspAllOfData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return TrackingDetailedStatsListRspAllOfData(
        stats: TrackingDetailedStats.listFromJson(json[r'stats']),
  ...
  static List<TrackingDetailedStatsListRspAllOfData> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TrackingDetailedStatsListRspAllOfData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
