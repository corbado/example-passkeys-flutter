...
class AndroidAppConfigUpdateRsp {
  /// Returns a new [AndroidAppConfigUpdateRsp] instance.
  ...
  /// Returns a new [AndroidAppConfigUpdateRsp] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AndroidAppConfigUpdateRsp? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<AndroidAppConfigUpdateRsp> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AndroidAppConfigUpdateRsp.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AndroidAppConfigUpdateRsp> mapFromJson(dynamic json) {
    final map = <String, AndroidAppConfigUpdateRsp>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AndroidAppConfigUpdateRsp.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
