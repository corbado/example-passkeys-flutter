...
class EmailLinksDeleteReq {
  /// Returns a new [EmailLinksDeleteReq] instance.
  EmailLinksDeleteReq({
  ...
  /// Returns a new [EmailLinksDeleteReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EmailLinksDeleteReq? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<EmailLinksDeleteReq> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EmailLinksDeleteReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EmailLinksDeleteReq> mapFromJson(dynamic json) {
    final map = <String, EmailLinksDeleteReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EmailLinksDeleteReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
