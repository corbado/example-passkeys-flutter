...
class UserCustomLoginIdentifierCreateRspAllOf {
  /// Returns a new [UserCustomLoginIdentifierCreateRspAllOf] instance.
  UserCustomLoginIdentifierCreateRspAllOf({
    required this.data,
  });
  ...
  /// Returns a new [UserCustomLoginIdentifierCreateRspAllOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UserCustomLoginIdentifierCreateRspAllOf? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<UserCustomLoginIdentifierCreateRspAllOf> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UserCustomLoginIdentifierCreateRspAllOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
