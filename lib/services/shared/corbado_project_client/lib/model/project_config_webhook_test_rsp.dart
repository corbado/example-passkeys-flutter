...
class ProjectConfigWebhookTestRsp {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ProjectConfigWebhookTestRsp &&
  ...
  @override
  String toString() => 'ProjectConfigWebhookTestRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProjectConfigWebhookTestRsp[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProjectConfigWebhookTestRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ProjectConfigWebhookTestRsp> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ProjectConfigWebhookTestRsp>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProjectConfigWebhookTestRsp>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProjectConfigWebhookTestRsp.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
