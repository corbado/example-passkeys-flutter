...
class WebAuthnCredentialExistsRspAllOf {
  /// Returns a new [WebAuthnCredentialExistsRspAllOf] instance.
  WebAuthnCredentialExistsRspAllOf({
  ...
  /// Returns a new [WebAuthnCredentialExistsRspAllOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static WebAuthnCredentialExistsRspAllOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return WebAuthnCredentialExistsRspAllOf(
  ...
  static List<WebAuthnCredentialExistsRspAllOf> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = WebAuthnCredentialExistsRspAllOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, WebAuthnCredentialExistsRspAllOf> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = WebAuthnCredentialExistsRspAllOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
