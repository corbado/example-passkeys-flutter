...
class MeRsp {
  ...
  @override
  String toString() => 'MeRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, fullName=$fullName, userIdentifier=$userIdentifier, confirmed=$confirmed]';
